...
impl KeyCodes {
    ...
    pub const INPUT_PROP_BUTTONPAD: u16 = 0x02; /* has button: u16 = s under pad */
    pub const INPUT_PROP_SEMI_MT: u16 = 0x03; /* touch rectangle only */
    pub const INPUT_PROP_TOPBUTTONPAD: u16 = 0x04; /* softbuttons at top of pad */
    pub const INPUT_PROP_POINTING_STICK: u16 = 0x05; /* is a pointing stick */
    pub const INPUT_PROP_ACCELEROMETER: u16 = 0x06; /* has accelerometer */

    pub const INPUT_PROP_MAX: u16 = 0x1f;
    pub const INPUT_PROP_CNT: u16 = 0x1f + 1;
    ...
    pub const KEY_SCALE: u16 = 120; /* AL Compiz Scale : u16 = Expose */
    ...
    pub const KEY_MENU: u16 = 139; /* Menu : u16 = show menu */
    ...
    pub const KEY_DASHBOARD: u16 = 204; /* AL Dashboard */
    ...
    pub const KEY_SWITCHVIDEOMODE: u16 = 227; /* Cycle between available video outputs (Monitor/LCD/TV-out/etc) */
    ...
    pub const KEY_BRIGHTNESS_AUTO: u16 = 244; /* Set Auto Brightness: manual brightness control is off, rely on ambient */
    pub const KEY_BRIGHTNESS_ZERO: u16 = 244;
    pub const KEY_DISPLAY_OFF: u16 = 245; /* display device to off state */

    pub const KEY_WWAN: u16 = 246; /* Wireless WAN : u16 = LTE, UMTS, GSM, etc. */
    ...
    pub const BTN_TOOL_QUINTTAP: u16 = 0x148; /* Five fingers on trackpad */
    ...
    pub const BTN_TOOL_QUADTAP: u16 = 0x14f; /* Four fingers on trackpad */
    ...
    pub const KEY_PC: u16 = 0x178; /* Media Select Computer */
    pub const KEY_TV: u16 = 0x179; /* Media Select TV */
    pub const KEY_TV2: u16 = 0x17a; /* Media Select Cable */
    pub const KEY_VCR: u16 = 0x17b; /* Media Select VCR */
    pub const KEY_VCR2: u16 = 0x17c; /* VCR Plus */
    pub const KEY_SAT: u16 = 0x17d; /* Media Select Satellite */
    pub const KEY_SAT2: u16 = 0x17e;
    pub const KEY_CD: u16 = 0x17f; /* Media Select CD */
    pub const KEY_TAPE: u16 = 0x180; /* Media Select Tape */
    pub const KEY_RADIO: u16 = 0x181;
    pub const KEY_TUNER: u16 = 0x182; /* Media Select Tuner */
    pub const KEY_PLAYER: u16 = 0x183;
    pub const KEY_TEXT: u16 = 0x184;
    pub const KEY_DVD: u16 = 0x185; /* Media Select DVD */
    pub const KEY_AUX: u16 = 0x186;
    pub const KEY_MP3: u16 = 0x187;
    pub const KEY_AUDIO: u16 = 0x188; /* AL Audio Browser */
    pub const KEY_VIDEO: u16 = 0x189; /* AL Movie Browser */
    pub const KEY_DIRECTORY: u16 = 0x18a;
    pub const KEY_LIST: u16 = 0x18b;
    pub const KEY_MEMO: u16 = 0x18c; /* Media Select Messages */
    ...
    pub const KEY_CHANNELUP: u16 = 0x192; /* Channel Increment */
    pub const KEY_CHANNELDOWN: u16 = 0x193; /* Channel Decrement */
    pub const KEY_FIRST: u16 = 0x194;
    pub const KEY_LAST: u16 = 0x195; /* Recall Last */
    ...
    pub const KEY_VIDEOPHONE: u16 = 0x1a0; /* Media Select Video Phone */
    pub const KEY_GAMES: u16 = 0x1a1; /* Media Select Games */
    pub const KEY_ZOOMIN: u16 = 0x1a2; /* AC Zoom In */
    pub const KEY_ZOOMOUT: u16 = 0x1a3; /* AC Zoom Out */
    pub const KEY_ZOOMRESET: u16 = 0x1a4; /* AC Zoom */
    pub const KEY_WORDPROCESSOR: u16 = 0x1a5; /* AL Word Processor */
    pub const KEY_EDITOR: u16 = 0x1a6; /* AL Text Editor */
    pub const KEY_SPREADSHEET: u16 = 0x1a7; /* AL Spreadsheet */
    pub const KEY_GRAPHICSEDITOR: u16 = 0x1a8; /* AL Graphics Editor */
    pub const KEY_PRESENTATION: u16 = 0x1a9; /* AL Presentation App */
    pub const KEY_DATABASE: u16 = 0x1aa; /* AL Database App */
    pub const KEY_NEWS: u16 = 0x1ab; /* AL Newsreader */
    pub const KEY_VOICEMAIL: u16 = 0x1ac; /* AL Voicemail */
    pub const KEY_ADDRESSBOOK: u16 = 0x1ad; /* AL Contacts/Address Book */
    pub const KEY_MESSENGER: u16 = 0x1ae; /* AL Instant Messaging */
    pub const KEY_DISPLAYTOGGLE: u16 = 0x1af; /* Turn display : u16 = LCD on and off */
    pub const KEY_BRIGHTNESS_TOGGLE: u16 = 0x1af;
    pub const KEY_SPELLCHECK: u16 = 0x1b0; /* AL Spell Check */
    pub const KEY_LOGOFF: u16 = 0x1b1; /* AL Logoff */

    pub const KEY_DOLLAR: u16 = 0x1b2;
    pub const KEY_EURO: u16 = 0x1b3;

    pub const KEY_FRAMEBACK: u16 = 0x1b4; /* Consumer - transport controls */
    pub const KEY_FRAMEFORWARD: u16 = 0x1b5;
    pub const KEY_CONTEXT_MENU: u16 = 0x1b6; /* GenDesc - system context menu */
    pub const KEY_MEDIA_REPEAT: u16 = 0x1b7; /* Consumer - transport control */
    pub const KEY_10CHANNELSUP: u16 = 0x1b8; /* 10 channels up : u16 = 10+ */
    pub const KEY_10CHANNELSDOWN: u16 = 0x1b9; /* 10 channels down : u16 = 10- */
    pub const KEY_IMAGES: u16 = 0x1ba; /* AL Image Browser */
    ...
    pub const KEY_NUMERIC_0: u16 = 0x200; /* used by phones, remote controls, */
    pub const KEY_NUMERIC_1: u16 = 0x201; /* and other keypads */
    ...
    pub const KEY_NUMERIC_A: u16 = 0x20c; /* Phone key A - HUT Telephony 0xb9 */
    ...
    pub const KEY_WPS_BUTTON: u16 = 0x211; /* WiFi Protected Setup key */

    pub const KEY_TOUCHPAD_TOGGLE: u16 = 0x212; /* Request switch touchpad on or off */
    ...
    pub const KEY_ATTENDANT_TOGGLE: u16 = 0x21d; /* Attendant call on or off */
    pub const KEY_LIGHTS_TOGGLE: u16 = 0x21e; /* Reading light on or off */
    ...
    pub const KEY_ALS_TOGGLE: u16 = 0x230; /* Ambient light sensor */

    pub const KEY_BUTTONCONFIG: u16 = 0x240; /* AL Button Configuration */
    pub const KEY_TASKMANAGER: u16 = 0x241; /* AL Task/Project Manager */
    pub const KEY_JOURNAL: u16 = 0x242; /* AL Log/Journal/Timecard */
    pub const KEY_CONTROLPANEL: u16 = 0x243; /* AL Control Panel */
    pub const KEY_APPSELECT: u16 = 0x244; /* AL Select Task/Application */
    pub const KEY_SCREENSAVER: u16 = 0x245; /* AL Screen Saver */
    pub const KEY_VOICECOMMAND: u16 = 0x246; /* Listening Voice Command */

    pub const KEY_BRIGHTNESS_MIN: u16 = 0x250; /* Set Brightness to Minimum */
    pub const KEY_BRIGHTNESS_MAX: u16 = 0x251; /* Set Brightness to Maximum */
    ...
    pub const REL_HWHEEL: u16 = 12; // high resolution wheel
    pub const REL_DIAL: u16 = 0x07;
    pub const REL_WHEEL: u16 = 11; // high resolution wheel
    pub const REL_MISC: u16 = 0x09;
    pub const REL_MAX: u16 = 0x0f;
    pub const REL_CNT: u16 = 0x0f + 1;
    ...
    pub const ABS_MT_TOUCH_MINOR: u16 = 0x31; /* Minor axis : u16 = omit if circular */
    pub const ABS_MT_WIDTH_MAJOR: u16 = 0x32; /* Major axis of approaching ellipse */
    pub const ABS_MT_WIDTH_MINOR: u16 = 0x33; /* Minor axis : u16 = omit if circular */
    ...
    pub const ABS_MT_PRESSURE: u16 = 0x3a; /* Pressure on contact area */
    pub const ABS_MT_DISTANCE: u16 = 0x3b; /* Contact hover distance */
    pub const ABS_MT_TOOL_X: u16 = 0x3c; /* Center X tool position */
    pub const ABS_MT_TOOL_Y: u16 = 0x3d; /* Center Y tool position */

    pub const ABS_MAX: u16 = 0x3f;
    pub const ABS_CNT: u16 = 0x3f + 1;

    /*
     * Switch events
     */

    pub const SW_LID: u16 = 0x00; /* set = lid shut */
    pub const SW_TABLET_MODE: u16 = 0x01; /* set = tablet mode */
    pub const SW_HEADPHONE_INSERT: u16 = 0x02; /* set = inserted */
    pub const SW_RFKILL_ALL: u16 = 0x03; /* rfkill master switch, type "any" set = radio enabled */
    pub const SW_RADIO: u16 = 0x03; /* deprecated */
    pub const SW_MICROPHONE_INSERT: u16 = 0x04; /* set = inserted */
    pub const SW_DOCK: u16 = 0x05; /* set = plugged into dock */
    pub const SW_LINEOUT_INSERT: u16 = 0x06; /* set = inserted */
    pub const SW_JACK_PHYSICAL_INSERT: u16 = 0x07; /* set = mechanical switch set */
    pub const SW_VIDEOOUT_INSERT: u16 = 0x08; /* set = inserted */
    pub const SW_CAMERA_LENS_COVER: u16 = 0x09; /* set = lens covered */
    pub const SW_KEYPAD_SLIDE: u16 = 0x0a; /* set = keypad slide out */
    pub const SW_FRONT_PROXIMITY: u16 = 0x0b; /* set = front proximity sensor active */
    pub const SW_ROTATE_LOCK: u16 = 0x0c; /* set = rotate locked/disabled */
    pub const SW_LINEIN_INSERT: u16 = 0x0d; /* set = inserted */
    pub const SW_MUTE_DEVICE: u16 = 0x0e; /* set = device disabled */
    pub const SW_MAX: u16 = 0x0f;
    pub const SW_CNT: u16 = 0x0f + 1;
